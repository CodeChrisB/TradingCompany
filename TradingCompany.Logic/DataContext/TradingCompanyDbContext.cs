...
{
    internal partial class TradingCompanyDbContext : DbContext, DataContext.IContext
	{
		static TradingCompanyDbContext()
		{
			ClassConstructing();
			//ConnectionString = CommonBase.Modules.Configuration.AppSettings.Configuration["ConnectionStrings:DefaultConnection"];
			ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=TradingCompanyDb;Integrated Security=True";
			ClassConstructed();
		}
