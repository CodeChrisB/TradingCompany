...
{
    using System;
    partial class Order : TradingCompany.Contracts.Persistence.App.IOrder
    {
        static Order()
        {
            ClassConstructing();
        ...
        {
            if (obj is not TradingCompany.Contracts.Persistence.App.IOrder instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(TradingCompany.Contracts.Persistence.App.IOrder other)
        {
            if (other == null)
            {
                return false;
