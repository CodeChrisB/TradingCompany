...
{
    using System;
    partial class Condition : TradingCompany.Contracts.Persistence.ItemMaster.ICondition
    {
        static Condition()
        {
            ClassConstructing();
        ...
        {
            if (obj is not TradingCompany.Contracts.Persistence.ItemMaster.ICondition instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(TradingCompany.Contracts.Persistence.ItemMaster.ICondition other)
        {
            if (other == null)
            {
                return false;
