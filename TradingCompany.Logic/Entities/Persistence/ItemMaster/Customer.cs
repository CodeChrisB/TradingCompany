...
{
    using System;
    partial class Customer : TradingCompany.Contracts.Persistence.ItemMaster.ICustomer
    {
        static Customer()
        {
            ClassConstructing();
        ...
        {
            if (obj is not TradingCompany.Contracts.Persistence.ItemMaster.ICustomer instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(TradingCompany.Contracts.Persistence.ItemMaster.ICustomer other)
        {
            if (other == null)
            {
                return false;
